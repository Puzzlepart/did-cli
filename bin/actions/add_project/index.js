...
function action(args) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            (0, log_1.printSeparator)('project add', true, log_1.cyan);
            const { client, db } = yield (0, client_1.getClient)();
            const customers = yield db.collection('customers').find({}).toArray();
            const input = yield inquirer_1.default.prompt((0, questions_1.default)(args, customers));
            ...
            (0, log_1.printSeparator)(`Project ${_id} succesfully created`, true, log_1.green);
            yield client.close(true);
        }
        catch (error) {
            (0, log_1.printSeparator)(`Failed to create project: ${error.message}`, true, log_1.yellow);
        }
        finally {
            process.exit(0);
        }
